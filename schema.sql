...
-- Seed initial data
insert
or ignore into orgs (id, org_code, display_name)
values
  (
    'bfa77ccf-8e42-4120-b500-715980343adc',
    'gingerteksolutions',
    'GingerTek Solutions'
  );

insert
or ignore into org_settings (org_id, setting_key, setting_value)
values
  (
    'bfa77ccf-8e42-4120-b500-715980343adc',
    'invoice_template',
...
insert
or ignore into roles (id, org_id, role_name, bit_value)
values
  (
    '8b6205ad-c012-4675-9d44-968c6d410732',
    'bfa77ccf-8e42-4120-b500-715980343adc',
    'admin',
    4294967295
  ),
  (
    '39114570-fd65-4153-8ea2-56e4b8338eed',
    'bfa77ccf-8e42-4120-b500-715980343adc',
    'invoice_manager',
    30
  );
...
values
  (
    ...
    'Jeremy M',
    'jmoormann',
    '$2y$12$wSJcOQItXyQJQ0Sp2lOr/eeCwHidIrDzRVlZctKBbMS9gamCLB03u',
    '8b6205ad-c012-4675-9d44-968c6d410732'
  ),
  (
    '4b28f715-105f-48d3-993f-1f33b35fafd0',
    'bfa77ccf-8e42-4120-b500-715980343adc',
    'Guest',
    'guest',
    '$2y$12$wSJcOQItXyQJQ0Sp2lOr/eeCwHidIrDzRVlZctKBbMS9gamCLB03u',
...
values
  (
    '489ed9db-5e97-4671-ae47-7c0b611deada',
    'bfa77ccf-8e42-4120-b500-715980343adc',
    'Acme Corporation',
    'info@acme.com',
    '123-456-7890',
